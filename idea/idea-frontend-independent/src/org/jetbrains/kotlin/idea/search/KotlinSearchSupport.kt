...
interface KotlinSearchUsagesSupport {
    ...
    interface ConstructorCallEquivalenceHandle {
    ...
    companion object {
        ...
        fun createKotlinCtorHandle(ktDeclaration: KtDeclaration): ConstructorCallEquivalenceHandle =
            getInstance(ktDeclaration.project).createKotlinCtorHandle(ktDeclaration)

        fun createJavaCtorHandle(psiMethod: PsiMethod): ConstructorCallEquivalenceHandle =
            getInstance(psiMethod.project).createJavaCtorHandle(psiMethod)
    }
