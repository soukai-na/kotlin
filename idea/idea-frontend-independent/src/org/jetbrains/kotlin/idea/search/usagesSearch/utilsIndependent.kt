...
import org.jetbrains.kotlin.idea.search.KotlinSearchUsagesSupport.Companion.createJavaCtorHandle
import org.jetbrains.kotlin.idea.search.KotlinSearchUsagesSupport.Companion.createKotlinCtorHandle
...
private fun PsiElement.buildProcessDelegationCallKotlinConstructorUsagesTask(
    ...
    val constructorHandler = createKotlinCtorHandle(element)
...
private fun PsiElement.buildProcessDelegationCallJavaConstructorUsagesTask(
    ...
    val ctorHandle = createJavaCtorHandle(this)
...
private fun processInheritorsDelegatingCallToSpecifiedConstructor(
    klass: PsiElement,
    scope: SearchScope,
    constructorCallComparator: KotlinSearchUsagesSupport.ConstructorCallEquivalenceHandle,
    process: (KtCallElement) -> Boolean
): Boolean {
...
private fun processClassDelegationCallsToSpecifiedConstructor(
    ...
    for (secondaryConstructor in klass.secondaryConstructors) {
        ...
        if (constructorCallComparator.referencedTo(delegationCall)) {
