...
class KotlinSearchUsagesSupportImpl : KotlinSearchUsagesSupport {
    ...
    override fun createKotlinCtorHandle(ktDeclaration: KtDeclaration): KotlinSearchUsagesSupport.ConstructorCallEquivalenceHandle =
        KotlinConstructorCallLazyDescriptorEquivalenceHandle(ktDeclaration)

    override fun createJavaCtorHandle(psiMethod: PsiMethod): KotlinSearchUsagesSupport.ConstructorCallEquivalenceHandle =
        JavaConstructorCallLazyDescriptorEquivalenceHandle(psiMethod)
}