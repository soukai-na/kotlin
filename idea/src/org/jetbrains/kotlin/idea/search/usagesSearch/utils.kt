...
class KotlinConstructorCallLazyDescriptorEquivalenceHandle(ktElement: KtDeclaration) :
    KotlinSearchUsagesSupport.ConstructorCallEquivalenceHandle {
...
class JavaConstructorCallLazyDescriptorEquivalenceHandle(psiMethod: PsiMethod) :
    KotlinSearchUsagesSupport.ConstructorCallEquivalenceHandle {
